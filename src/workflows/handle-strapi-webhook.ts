...
export const handleStrapiWebhookWorkflow = createWorkflow(
  ...
  (input: WorkflowInput) => {
    ...
    when(input, (input) => input.entry.model === "product").then(() => {
    ...
    when(input, (input) => input.entry.model === "product-variant").then(() => {
    ...
    when(input, (input) => input.entry.model === "product-option").then(() => {
    ...
    when(input, (input) => input.entry.model === "product-option-value").then(
      () => {
